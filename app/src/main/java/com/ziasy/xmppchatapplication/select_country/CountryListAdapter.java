...
/**
 * Created by bhushan on 19/11/15.
 */
public class CountryListAdapter extends BaseAdapter {
    ArrayList<CountryModel> mCountryList, mTempCountryList;
    Context context;
    // FavWishHolderNewItem holder;
    //  WallAdapterHolder holder;
...
@Override     public int getCount() {
    ...
    /* get object item id of current position */@Override     public Object getItem(int position) {
        return mCountryList.get(position);
    }

    /*get item id of current position*/@Override     public long getItemId(int position) {
        return position;
    }


    /* Add row layout *//* Add row layout */@Override
