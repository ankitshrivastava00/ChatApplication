...
import com.ziasy.xmppchatapplication.multiimage.adapters.CustomImageSelectAdapter;
...
public class ImageSelectActivity extends HelperActivity {
    ...
    private void toggleSelection(int position) {
        if (!images.get(position).isSelected && countSelected >=Constants.DEFAULT_LIMIT) {
            Toast.makeText(
