package com.ziasy.xmppchatapplication.multiimage.activities;
...
import com.ziasy.xmppchatapplication.multiimage.adapters.CustomAlbumSelectAdapter;
import com.ziasy.xmppchatapplication.multiimage.helpers.Constants;
import com.ziasy.xmppchatapplication.multiimage.models.Album;
...
public class AlbumSelectActivity extends HelperActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar_title.setText("Select Album");
                ...
                do {
                 ...
                 //   String size = cursor.getString(cursor.getColumnIndex(projection[3]));
                    ...
                    if (!albumSet.contains(albumId)) {
                        ...
                        file = new File(image);
                        if (file.exists()) {
                            temp.add(new Album(album, image,"100"));
