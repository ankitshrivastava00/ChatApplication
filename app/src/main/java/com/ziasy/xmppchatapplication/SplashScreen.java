...
import static com.ziasy.xmppchatapplication.baidu.ConfigurationSettings.API_KEY;
...
public class SplashScreen extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        PushManager.startWork(SplashScreen.this, PushConstants.LOGIN_TYPE_API_KEY, API_KEY);
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                if (sd.getLoginStatus().equalsIgnoreCase("true")&&sd.getLoginStatus().equalsIgnoreCase("false")) {
                    ...
                    startActivity(i);
                    finish();
                } else    if (sd.getLoginStatus().equalsIgnoreCase("true")&&sd.getLoginStatus().equalsIgnoreCase("true")) {
