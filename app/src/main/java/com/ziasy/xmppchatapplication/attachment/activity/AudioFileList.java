...
import com.ziasy.xmppchatapplication.attachment.adapter.AudioAdapter;

import java.io.File;
import java.util.ArrayList;

public class AudioFileList extends AppCompatActivity {
        ...
        if (listFile != null && listFile.length > 0) {
            for (int i = 0; i < listFile.length; i++) {
                ...
                if (listFile[i].isDirectory()) {
                    ...
                    if (listFile[i].getName().toLowerCase().endsWith(".mp3")) {
