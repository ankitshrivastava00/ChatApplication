...
public class FullScreenViewActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sd = new SessionManagement(FullScreenViewActivity.this);
        cd = new ConnectionDetector(FullScreenViewActivity.this);
       ...
       /* viewPager.setOnClickListener(new View.OnClickListener() {
        ...
        saveLinear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    boolean storagepermission = Permission.checkReadExternalStoragePermission(FullScreenViewActivity.this);
                    boolean externalStroage = Permission.permissionForExternal(FullScreenViewActivity.this);
                    if (storagepermission) {
                        if (externalStroage) {
                            int i = viewPager.getCurrentItem();
                            if (adapter != null) {
                                adapter.saveImage(FullScreenViewActivity.this, i);
                                // downloadFile(position);
                                //   Utils.downloadFile(FullScreenViewActivity.this, strImagePath.get(0), strFileName);
                                Toast.makeText(FullScreenViewActivity.this, "Image Saved", Toast.LENGTH_SHORT).show();
                    ...
                    e.printStackTrace();
                    Toast.makeText(FullScreenViewActivity.this, "No space available", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        forwardLinear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (adapter != null) {
                    ...
                    // downloadFile(position);
                    //   Utils.downloadFile(FullScreenViewActivity.this, strImagePath.get(0), strFileName);
                    Toast.makeText(FullScreenViewActivity.this, "Forward", Toast.LENGTH_SHORT).show();
...
//                        progressDialog.show();
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            if (!cd.isConnectingToInternet()) {
                                Toast.makeText(FullScreenViewActivity.this, "No work", Toast.LENGTH_SHORT).show();
