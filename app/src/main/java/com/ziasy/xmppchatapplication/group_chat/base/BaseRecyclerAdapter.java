package com.ziasy.xmppchatapplication.group_chat.base;
...
public abstract class BaseRecyclerAdapter<VH extends RecyclerView.ViewHolder, Data> extends RecyclerView.Adapter<VH> {
    ...
    public void onBindViewHolder(VH holder, int position) {
        ((ViewHolder) holder).bindData(getItem(position),position,getContext());
    }
    ...
    public abstract class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public abstract void bindData(Data data,int position,Context context);
    }
