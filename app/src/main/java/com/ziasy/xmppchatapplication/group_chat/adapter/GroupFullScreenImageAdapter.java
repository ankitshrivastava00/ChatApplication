...
public class GroupFullScreenImageAdapter extends PagerAdapter {

    private Activity _activity;
    private List<JsonModelForChat> _imagePaths;
    private LayoutInflater inflater;
    private GroupFullScreenViewActivity fullScreenViewActivity;

    // constructor
    public GroupFullScreenImageAdapter(Activity activity,
                                       List<JsonModelForChat> imagePaths) {
        this.fullScreenViewActivity = (GroupFullScreenViewActivity) activity;
    ...
    public Object instantiateItem(ViewGroup container, int position) {
      ...
      *//*  Bitmap bitmap = BitmapFactory.decodeFile(_imagePaths.get(position).getMessage(), options);
        ...
        Glide.with(_activity)
                .load(_imagePaths.get(position).getMessage())
                .into(imgDisplay);
